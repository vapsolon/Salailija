...
/**
 * Karkea Quicksort-toteutus jonka päälle vielä hieman kömpelösti rakennettu
 * toiminnallisuus pilkkoa pikajärjestetty merkkijono edelleen listaksi
 * merkkijonon merkkien sisäisestä aakkosjärjestyksestä. <br>
 * Apuna datatyyppi CharIndex joka pitää kirjaa merkin alkuperäisestä
 * sijanumerosta jonossa jotta järjestyksen jälkeen on helppoa luoda lista
 * pelkästään järjestysmuutoksista.
 * @author vapsolon
 */
